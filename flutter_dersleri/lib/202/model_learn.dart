...
class PostModel7 {
  ...
  PostModel7(
      {int userId = 0, int id = 1, String title = 'a', String body = 'b'}) {
    userId = userId;
    id = id;
    title = title;
    body = body;
...
class PostModel8 {
  ...
  void updateBody(String? data) {
    // data.length hata verir çünkü burda null gelip gelmediğini bilmiyo fonk sonrada aynı hatayı verir
    // ama data?.length diyebilirsin
